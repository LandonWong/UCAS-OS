...
pcb_t pid0_pcb_core0 = {
    .pid = 0,
    .kernel_sp = (ptr_t)(0x50500e70),
    .user_sp = (ptr_t)0x50502000,
    .preempt_count = 0
};
pcb_t pid0_pcb_core1 = {
    .pid = 0,
    .kernel_sp = (ptr_t)(0x50502e70),
    .user_sp = (ptr_t)0x50504000,
    .preempt_count = 0
};
...
void do_scheduler(void)
{
      ...
      current_running = (get_current_cpu_id() == 0) ? &current_running_core0 : &current_running_core1;
        ...
        if(((pcb_t *)(*current_running))->status == TASK_RUNNING && ((pcb_t *)(*current_running))->pid != 0){ 
        ...
        *current_running = next_running;
        ...
        //vt100_move_cursor(((pcb_t *)(*current_running))->cursor_x,
